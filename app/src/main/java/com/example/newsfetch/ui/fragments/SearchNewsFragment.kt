...
import com.example.newsfetch.utils.Constants
import com.example.newsfetch.utils.Constants.Companion.SEARCH_NEWS_TIME_DELAY
...
class SearchNewsFragment : Fragment(R.layout.fragment_search_news) {
    ...
    private val TAG = "SearchNewsFragemnt"
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        etSearch.addTextChangedListener {editable->
            job?.cancel()  //cancle the previous job
//            mainscope to run in the main therad
            ...
            job = MainScope().launch {
                ...
                editable?.let {
                    if(editable.toString().isNotEmpty()){
                        ...
                        viewModel.searchNewsResonse?.articles?.clear()
